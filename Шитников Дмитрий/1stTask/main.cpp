...
map<char*, size_t, MyComparator, CustomAllocator<char*>> map_with_custom_allocator(char* text) {
    auto word_counter = map<char*, size_t, MyComparator, CustomAllocator<char*>>();
